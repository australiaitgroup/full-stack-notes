...
- 变量在使用前需要先声明，声明的本质是为变量分配内存空间。常用的声明变量的关键字有 let、const 和 var，它们有一些区别
  ![var_let_const](../images/var_let_const.jpg)
- let： 具有块级作用域，可重新赋值。
...
- 变量，属性，函数，参数 取名不能是关键字和保留字
  ![js_keyword](../images/js_keyword.jpg)
- 常使用驼峰命名法
...
1. 使用 typeof 判断数据类型
   ...
   ![js_typeof](../images/js_typeof.jpg)

2. 使用 instanceof 判断数据类型

   ![js_instanceif](../images/js_instanceif.jpg)
...
运算符优先级
![js_compare_priority](../images/js_compare_priority.jpg)
